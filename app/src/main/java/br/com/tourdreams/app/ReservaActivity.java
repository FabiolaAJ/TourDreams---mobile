...
public class ReservaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_preco_reserva.setText( f.format( Double.parseDouble(preco_quarto)));
    ...
    private class criar_reserva extends AsyncTask<Void,Void,Void>{
        ...
        protected void onPostExecute(Void aVoid) {
           ...
           // editor.apply();
            ...
            total_dias.setText(String.format("Total de dias: %d ", dias_totais));\

            double valor_total;
            valor_total =  dados.getValor_total();

            NumberFormat f = NumberFormat.getCurrencyInstance(new Locale("pt", "BR"));
            total_valor.setText( f.format((valor_total)));

            //total_valor.setText(String.format("Valor total: %.2f", valor_total));
